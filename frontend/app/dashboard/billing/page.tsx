...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['1 database (100 MB)', 'LSM-Tree engine only', '100 queries/hr', 'Community support'] },
  { name: 'Pro', price: '$79/mo', features: ['10 databases (50 GB each)', 'All engines: LSM-Tree, B-Tree, Columnar', 'Sync/async replication', 'ALICE-Zip compression', '10,000 queries/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited databases', 'Unlimited storage', 'Multi-region replication', 'Dedicated clusters', 'SLA 99.99%', 'Custom deployment'] },
];
